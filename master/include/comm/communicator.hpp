...
public:
  ...
  int send_message(unsigned int len, const unsigned char *buffer,
...
int Communicator::send_message(unsigned int len, const unsigned char *buffer,
                               const unsigned int id) {
